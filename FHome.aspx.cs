...
public partial class _Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query3 = "Select roomnumber from faculty where username = @username";
        string query4 = "Select schoolyear from faculty where username = @username";
        ...
        string query9 = "select bloodgroup from faculty F join users U on U.username = F.username AND F.username = @username";
    ...
    protected void Button9_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand command = new SqlCommand("select studentID,name,description,percentage from feedback join users on users.username = feedback.studentID where facultyID = @username", connection);
