...
public partial class Fmarks : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            previouscourse = (string)Session["coursemarks"];
    ...
    protected void Button10_Click(object sender, EventArgs e)
    {
        ...
        string type=DropDownList3.SelectedValue;
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                string query = "INSERT INTO " + type + " (obtainedmarks, totalmarks, courseid, studentid, facultyid) VALUES ('" + obtainedValue + "', '" + totalValue + "', '" + course + "', '" + rollNumber + "', '" + username + "')";
