...
public partial class _Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query = "SELECT distinct studentid,courseID FROM studies WHERE studentid = @username";
        string query1 = "SELECT obtainedmarks, totalmarks FROM quiz WHERE studentID = @username AND courseid = @course";
        string query2 = "SELECT obtainedmarks, totalmarks FROM Assignment WHERE studentID = @username AND courseid = @course";
        string query3 = "SELECT obtainedmarks, totalmarks FROM sessionals WHERE studentID = @username AND courseid = @course";
        string query4 = "SELECT obtainedmarks, totalmarks FROM Project WHERE studentID = @username AND courseid = @course";
        string query5 = "SELECT obtainedmarks, totalmarks FROM final WHERE studentID = @username AND courseid = @course";
        ...
        if (!IsPostBack)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                Session["coursemarks"] = DropDownList1.SelectedValue;
        ...
        {
            prevcourse = (string)Session["coursemarks"];
            course = DropDownList1.SelectedValue;
