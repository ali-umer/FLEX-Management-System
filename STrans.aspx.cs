...
public partial class Strans : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query2 = "select name from students S join users u on u.username = S.Rollnum where Rollnum = @username";
        ...
        string query5 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 1 ;";
        string query6 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 2 ;";
        string query7 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 3 ;";
        string query8 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 4 ;";
        string query9 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 5 ;";
        string query10 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 6 ;";
        string query11 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 7 ;";
        string query12 = "select distinct(S.Rollnum),C.name,C.credithours,G.grade from students S join grades G on G.studentID = S.Rollnum join courses C on C.ID = G.courseID  WHERE S.Rollnum = @username AND C.semester = 8 ;";
