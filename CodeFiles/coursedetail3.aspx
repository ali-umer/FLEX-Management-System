<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coursedetail3.aspx.cs" Inherits="coursedetail3" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 5 - Excellent
        ...
        <br />
            -------------------------------------------------------------------------------------------------------------------------------------------------------<br />
            <asp:Label ID="Label20" runat="server" Text="Label" ForeColor="Black" CssClass="auto-style1"></asp:Label>
            <br />
            <br />
            <br />
            &nbsp;
