...
public partial class Sfeedbackredirector : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query1 = "select C.ID,C.name from students S join studies st on st.studentID = S.Rollnum join courses C on C.ID = st.courseID where S.Rollnum = @username ";
