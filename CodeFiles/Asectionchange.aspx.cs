...
public partial class Asectionchange : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query1 = "select distinct courseid from studies where studentID= @id";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string query1 = "select count(*) from studies where courseID = @course and section = @section";
        string query2 = "update studies set section = @section where courseID=@course and studentID=@id";
        int count = 0;
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            connection.Open();
